(function ($, $S) {
    ...
    if (len) {
        for (var i = 0; i < len; i++) {
            ...
            currentNotes += '<div id="postick" class="postick"';
            ...
            currentNotes += '">x</span></div><div contenteditable="true" class="editable" id="editable">';
            currentNotes += o.text;
            currentNotes += '</div>';
        }
    ...
    $('#btn-addNote').click(function () {
        $board.append('<div id="postick" class="postick" style="left:20px;top:70px"><div class="toolbar"><span id="delete" class="delete">x</span></div><div contenteditable class="editable" id="editable"></div></div>');
        $(".postick").draggable({
            cancel: '.editable'
        });
    });
